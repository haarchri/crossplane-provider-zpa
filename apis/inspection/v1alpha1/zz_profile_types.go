...
type ProfileCustomControlsObservation struct {
}

type ProfileCustomControlsParameters struct {
...
type ProfileParameters struct {
	...
	// +kubebuilder:validation:Optional
	CustomControls []ProfileCustomControlsParameters `json:"customControls,omitempty" tf:"custom_controls,omitempty"`
