...
type CommonAppsDtoAppsConfigObservation struct {
}

type CommonAppsDtoAppsConfigParameters struct {
...
type SegmentPraCommonAppsDtoObservation struct {
}

type SegmentPraCommonAppsDtoParameters struct {

	// +kubebuilder:validation:Optional
	AppsConfig []CommonAppsDtoAppsConfigParameters `json:"appsConfig,omitempty" tf:"apps_config,omitempty"`
}
...
type SegmentPraParameters struct {
	...
	// +kubebuilder:validation:Optional
	CommonAppsDto []SegmentPraCommonAppsDtoParameters `json:"commonAppsDto,omitempty" tf:"common_apps_dto,omitempty"`
	...
	// +kubebuilder:validation:Required
	ServerGroups []SegmentPraServerGroupsParameters `json:"serverGroups" tf:"server_groups,omitempty"`

	// tcp port range
	// +kubebuilder:validation:Optional
	TCPPortRange []SegmentPraTCPPortRangeParameters `json:"tcpPortRange,omitempty" tf:"tcp_port_range,omitempty"`
	...
	// udp port range
	// +kubebuilder:validation:Optional
	UDPPortRange []SegmentPraUDPPortRangeParameters `json:"udpPortRange,omitempty" tf:"udp_port_range,omitempty"`
...
type SegmentPraServerGroupsObservation struct {
}

type SegmentPraServerGroupsParameters struct {

	// +kubebuilder:validation:Required
	ID []*string `json:"id" tf:"id,omitempty"`
}

type SegmentPraTCPPortRangeObservation struct {
}

type SegmentPraTCPPortRangeParameters struct {
...
type SegmentPraUDPPortRangeObservation struct {
}

type SegmentPraUDPPortRangeParameters struct {
