...
type SegmentInspectionParameters struct {
	...
	// +kubebuilder:validation:Required
	ServerGroups []SegmentInspectionServerGroupsParameters `json:"serverGroups" tf:"server_groups,omitempty"`

	// tcp port range
	// +kubebuilder:validation:Optional
	TCPPortRange []SegmentInspectionTCPPortRangeParameters `json:"tcpPortRange,omitempty" tf:"tcp_port_range,omitempty"`
	...
	// udp port range
	// +kubebuilder:validation:Optional
	UDPPortRange []SegmentInspectionUDPPortRangeParameters `json:"udpPortRange,omitempty" tf:"udp_port_range,omitempty"`
...
type SegmentInspectionServerGroupsObservation struct {
}

type SegmentInspectionServerGroupsParameters struct {

	// +kubebuilder:validation:Required
	ID []*string `json:"id" tf:"id,omitempty"`
}

type SegmentInspectionTCPPortRangeObservation struct {
}

type SegmentInspectionTCPPortRangeParameters struct {
...
type SegmentInspectionUDPPortRangeObservation struct {
}

type SegmentInspectionUDPPortRangeParameters struct {
