...
type ConditionsOperandsObservation struct {
	ID *string `json:"id,omitempty" tf:"id,omitempty"`
}

type ConditionsOperandsParameters struct {
...
type InspectionRuleConditionsObservation struct {
	ID *string `json:"id,omitempty" tf:"id,omitempty"`

	// This signifies the various policy criteria.
	// +kubebuilder:validation:Optional
	Operands []ConditionsOperandsObservation `json:"operands,omitempty" tf:"operands,omitempty"`
}

type InspectionRuleConditionsParameters struct {
	...
	// This signifies the various policy criteria.
	// +kubebuilder:validation:Optional
	Operands []ConditionsOperandsParameters `json:"operands,omitempty" tf:"operands,omitempty"`
...
type InspectionRuleObservation struct {
	...
	// +kubebuilder:validation:Optional
	Conditions []InspectionRuleConditionsObservation `json:"conditions,omitempty" tf:"conditions,omitempty"`
...
type InspectionRuleParameters struct {
	...
	// This is for proviidng the set of conditions for the policy.
	// +kubebuilder:validation:Optional
	Conditions []InspectionRuleConditionsParameters `json:"conditions,omitempty" tf:"conditions,omitempty"`
